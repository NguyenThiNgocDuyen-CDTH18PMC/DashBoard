...
<body>
	<div class="container">
    <form action="{{ route('lichchieu.store')}}" id="form-add" method="POST" role="form">
				{{ csrf_field() }}
			...
			<table class="table table-hover">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<input name="phong_id" type="number" class="form-control" id="tenchinhanh-add" placeholder="Nhập vào ID phòng">
					</div>
					<div class="form-group">
						<label for="">Thành Viên ID</label>
						<input name="thanhvien_id" type="number" class="form-control" id="tenchinhanh-add" placeholder="Nhập vào ID phòng">
					</div>
					<div class="form-group">
